# -*- coding: utf-8 -*-
"""
Created on Mon Apr 13 09:30:13 2020
...
downloadDirectory = dfUploadParameters[(dfUploadParameters['Field'].str.lower().str.strip()=='path') & (dfUploadParameters['Source'].str.lower().str.strip()=='pharmaview daily primary sector')]['Value'].item()
...
if(retries<5):
    ...
    dfLogFile.loc[dfLogFile['Script']=='PharmaviewDailyDataPrimarySector','Executed']= 1
